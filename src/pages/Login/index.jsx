...
import { Col, Form, Row, Card, Layout, Image } from 'antd';
...
const Login = () => {
  ...
  return (
    <Layout className="login-screen">
      <Content className="login-bg-image">
        <div className="official-logo">
          <Image src="/assets/images/logo.png" alt="mainlogo" preview={false} />
        </div>
        ...
        <Row className="footer-disclaimer-mob">
          ...
          <Col className="d-flex gap-5 mt-2 justify-content-center">{footerAreaText()}</Col>
        </Row>
        <Row className="footer-disclaimer">
          ...
          <Col span={7}></Col>
          <Col span={8} className="d-flex gap-3 justify-content-center">
            {footerAreaText()}
          </Col>
        </Row>
      </Content>
