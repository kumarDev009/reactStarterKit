...
import { LOGIN_FOOTER_DISCLAIMER_TEXT, STATIC_LOGIN_CREDENTIALS, HOME_PATH } from '../../constants';
...
const Login = () => {
  ...
  const footerAreaText = () => {
    return LOGIN_FOOTER_DISCLAIMER_TEXT.map((val, index) => {
      return <CustomFooterText className="cursor-pointer" footerLabel={val.label} />;
    });
  };
  return (
    <div>
            ...
            <div className="login-container">
              <Row>
                ...
                <Col className="d-flex justify-content-end" span={12}>
                  <CustomButton className="px-0" type="link" buttonText={"Don't have an account ?"} />
                </Col>
              </Row>
